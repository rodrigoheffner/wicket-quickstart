...
import org.rodrigo.bezerra.wicket.quickstart.page.Parent;
 ...
 * @author rodrigo
 */
@Url("/second-child.html")
@PageLabel("Second child page")
@Order(PageModel.MenuOrder.SECONDARY)
@Parent(TestParentPage.class)
public class TestSecondChildPage extends BootstrapPage {
